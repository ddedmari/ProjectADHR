...
public class AadhaarConfirmationAuth extends AsyncTask<String, Void, AuthResponse> {
	...
	LoanHistory mHistory;

	public AadhaarConfirmationAuth(Context context, AuthCaptureData authCaptureData, LoanHistory history) {
	...
	protected void onPostExecute(AuthResponse response) {
		...
		if (response.isSuccess()) {
			...
			intent.setClass(mContext, ConfirmationActivity.class);
			intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
			mContext.startActivity(intent);
			
			DBHelper dbHelper = new DBHelper(mContext);
			dbHelper.insertLoan(mHistory.getUid(), mHistory.getName(), mHistory.getAmount(), mHistory.getRoi(), mHistory.getTenure(), mHistory.getEnrollmentDate());
