...
import com.broids.projectadhr.ui.EnrollHealthUserActivity;
...
public class AadhaarHealthAuthAsyncTask extends AsyncTask<String, Void, AuthResponse> {
	...
	public AadhaarHealthAuthAsyncTask(Context context, AuthCaptureData authCaptureData, String caller,
			String value1, String value2, String value3, String value4, String value5, String value6, byte[] imageData
			) {
	...
	protected void onPostExecute(AuthResponse response) {
		...
		if (response.isSuccess()) {
			if (mCallerType.equals("TYPE_DOSE")) {
				...
				dbHelper.insertAndEnrollHealthUser(
						AadhaarUtil.mCurrentUserKYC.getAadhaar(), value1, value2,
